...
function initSmoothScroll() {
  document.querySelectorAll('a[href^="#"]').forEach(anchor => {
    anchor.addEventListener("click", e => {
      ...
      const navHeight = document.querySelector("header")?.offsetHeight || 90;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll(".project-card-link").forEach(link => {
    link.addEventListener("click", function (e) {
      ...
      modalLink.href = this.getAttribute("href");
 ...
 function initContactForm() {
  ...
  if (!form || !resultBox || !toast) return;
  ...
  form.addEventListener("submit", function (e) {
    ...
    resultBox.insertAdjacentHTML("afterbegin", card);
